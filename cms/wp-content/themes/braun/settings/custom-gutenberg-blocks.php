...
add_action( 'acf/init', function () {
	...
	// Regions Applicable block
	acf_register_block_type( [
		'name' => 'bfs-regions-applicable',
		'title' => __( 'Regions Applicable' ),
		'description' => __( 'A region selector.' ),
		'category' => 'white-gold',
		'icon' => 'location',
		'align' => 'wide',
		'mode' => 'edit',
	...
	acf_register_block_type( [
		'name' => 'bfs-section',
		'title' => __( 'Section Placements' ),
		'description' => __( 'Which page(s), and Where in each of them should this feature?' ),
		'category' => 'white-gold',
		'icon' => 'location-alt',
		'align' => 'wide',
		'mode' => 'edit',
