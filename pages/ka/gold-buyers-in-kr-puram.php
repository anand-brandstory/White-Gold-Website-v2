...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-kr-puram.php';
...
<style>
    .lp-krpuram .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 137%;
    z-index: 1;
}
.lp-krpuram .highlight .slick-next {
    position: absolute;
    top: 137%;
    right: 36%;
    z-index: 1;
}
.lp-krpuram .highlight .slick-dots {
