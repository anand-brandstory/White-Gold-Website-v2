...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-malleshwaram.php';
...
<style>
    .lp-malleshwaram .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 137%;
    z-index: 1;
}
.lp-malleshwaram .highlight .slick-next {
    position: absolute;
    top: 137%;
    right: 36%;
    z-index: 1;
}
.lp-malleshwaram .highlight .slick-dots {
