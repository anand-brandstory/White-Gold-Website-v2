...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-kathriguppe.php';
...
<style>
    .lp-kathriguppe .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 130%;
    z-index: 1;
}
.lp-kathriguppe .highlight .slick-next {
    position: absolute;
    top: 130%;
    right: 36%;
    z-index: 1;
}
.lp-kathriguppe .highlight .slick-dots {
