				...
				<div class="step-card-grid row">
					...
					<div class="card columns small-12 fill-light">
						...
						<div class="card-content">
							...
							<div class="row space-150-bottom space-50-left-right">
								<div class="columns small-8 small-offset-1 space-50-left-right">
					...
					<div class="card columns small-12 fill-light">
						...
						<div class="card-content">
							...
							<div class="row space-150-top space-50-left-right">
								<div class="columns small-1"><span class="checkmark h5 medium fill-blue-4 text-light">&check;</span></div>
								<div class="columns small-10 space-50-left-right"><div class="h3 text-blue-4 medium">Your money is transferred instantly to your bank account.</div></div>
							</div>
						</div>
					</div>
				</div>
