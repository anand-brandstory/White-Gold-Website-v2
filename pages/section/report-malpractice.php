				...
				<div class="row">
					<div class="columns small-5">
						<div class="fill-neutral-5 space-25 radius-25">
							<div class="fill-yellow-2 radius-25" style="padding-top: 75%; opacity: 0.5;"></div>
						</div>
					</div>
			...
			<div class="columns small-12 medium-6 large-8 space-50-bottom">
				<div class="report-malpractice-grid row">
					...
					<div class="complaint fill-neutral-5 space-50 radius-50">
						...
						<a href="" class="button fill-red-3"><img class="button-icon" src="../media/icon/info-outline.svg<?php echo $ver ?>"><span class="button-label">&ensp;File Complaint</span></a>
					</div>
				</div>
			</div>
		</div>
