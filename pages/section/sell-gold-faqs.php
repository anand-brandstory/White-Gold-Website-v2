						...
						<div class="faqs">
							<div class="faq">
								...
								<div class="answer fill-blue-4 radius-50">
									<div class="p space-50">Yes we will help you close your gold loan and release your pledged gold. For more details <a class="text-yellow-2" href="/<?= REGION ?>#release-gold-section">click here</a>.</div>
								</div>
							</div>
							<div class="faq">
